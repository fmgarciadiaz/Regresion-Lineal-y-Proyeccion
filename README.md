...
8. Con esta métrica puntos equidistantes a otro forman círculos concéntricos y su distancia es la raíz de la suma cuadrática de la diferencia de sus componentes (de nuevo: Pitágoras!) 

<img src="images/Distancia-euclides.png" width="50%">
<img src="images/Euclidiana.png" width="50%">

9. En cambio la distancia manhattan (asociada al MAD) es la suma de la diferencia absoluta de los componentes. En este caso los puntos equidistantes forman rombos (horrible!). Eso cambia sustancialmente la geometría del espacio.
...
10. Comparemos la distancia entre un punto Y y una recta en cada geometría. 
Debemos encontrar el punto sobre la recta con menor distancia a Y. Es decir, tenemos  que buscar un beta que minimice la distancia en cada caso
...
12. Veamos que esta minimización da resultados diferentes tanto para la distancia como para el punto más cercano. Con la métrica euclidiana el punto más cercano Pe está sobre el círculo tangente, mientras que con manhattan es Pm, el rombo tangente. 

<img src="images/Comaparacion2.png" width="50%">



12. El punto Pe luce más "natural" porque minimiza la distancia
euclidiana que "usamos" todos los días: el segmento entre Y y Pe es *perpendicular* a la recta.
...
13. Lo interesante del concepto de ángulo es que permite medir cuán "paralelos" son dos vectores. Cuando el ángulo es cero un vector puede escribise exactamente como múltiplo del otro. 
Cuando el ángulo crece los vectores son cada vez menos proporcionales.

![](images/angulos.png)

14. Los vectores perpendiculares son (lineamente) todo lo diferentes que pueden ser: en este caso se anula el producto interior (que en un espacio euclidio se define como la suma del producto de dos vectores componente a componente). 
...
ángulos ni proyecciones ortogonales. Peor aún, los puntos de mínima distancia pueden no ser únicos!
...
15. Noten la similitud de estas minimizaciones con la distancia de un punto a una recta que vimos antes. Es que, en esencia, ¡¡hacer una estimación puede interpretarse geométricamente de esa forma!!

16. Para visualizar esto fácilmente consideremos una regresión con una sola variable y y un regresor x, sin intercepto. Tomemos dos observaciones: para x=1 se observó y=2 y para x=2, y=5
...
17. La recta es el espacio que representa los puntos "barridos" por el vector x con cada valor de beta. Si lo miramos fijo descubrimos lo mencionado: estimar es minimizar la distancia entre la recta e y.
Y la solución varía con la geometría que estemos suponiendo.

<img src="images/MCO-step2.png" width="50%">


17. Como dijimos, MCO usa la distancia euclidiana: hay que trazar la perpendicular de Y a la recta (proyección ortogonal). En este ejemplo eso da (2,4, 4,8). El vector de errores es 
e=(2-2.4, 5-4,8)=(-0,4, 0,2). El beta es 2,4 ya que 2,4 * (1, 2) = (2,4, 4,8)

<img src="images/MCO-step3.png" width="50%">

18. El vector de errores es perpendicular a la recta, por lo que el producto interior se anula (-0,4 * 2.4)  + (0,2 * 4,8) = 0. 

<img src="images/MCO-step4.png" width="50%">

19. En cambio el MAD usa la distancia Mahattan y por lo tanto el y estimado (el punto más cercano de la recta) es diferente (2,5, 5). También el beta es distinto. El error ya no es ortogonal (la estimación ya no es una proyección ortogonal)

<img src="images/MCO-step5.png" width="50%">

20. Con más observaciones y regresores se hace imposible hacer una representación visual sencilla . Sin embargo, la interpretación geométrica sigue siendo la misma. Por eso el operador para estimar con el MCO se llama "matriz de proyección" 
...
21. Esta interpretación se puede generalizar de espacios de vectores de datos a variables aleatorias. En dicho caso hay que pensar en espacios de funciones, pero maravillosamente la geometría es la misma.

22. Los espacios euclidianos pasan a ser espacios de Hilbert (con norma L2) y la distancia Manhattan a espacios de Banach (con norma L1). Los espacios de Hilbert también tienen un producto interior y cuentan con
