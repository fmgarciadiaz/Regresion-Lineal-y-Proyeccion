...
\begin{document}
	...
	\begin{center}
		\begin{tikzpicture}[scale=1.5] % Ambos ejes con la misma escala
			...
			% Líneas punteadas para el punto ylad (2.5, 5)
			\draw[dashed, dash pattern=on 2pt off 2pt] (2.5,5) -- (2.5,0) node[below, font=\footnotesize] {2.5}; % Línea vertical
			\draw[dashed, dash pattern=on 2pt off 2pt] (2.5,5) -- (0,5) node[left, font=\footnotesize] {5};     % Línea horizontal
			
			% Líneas punteadas para el punto y (2, 5)
			\draw[dashed, dash pattern=on 2pt off 2pt] (2,5) -- (2,0) node[below, font=\footnotesize] {2}; % Línea vertical
			\draw[dashed, dash pattern=on 2pt off 2pt] (2,5) -- (0,5);                                   % Línea horizontal
			...
			% Punto ymc (2.4, 4.8) sin líneas punteadas ni etiquetas en los ejes
			\filldraw[blue] (2.4,4.8) circle (1.5pt) node[right, text=black, font=\footnotesize] {\footnotesize $\hat{y}_{mc}=(2.4,4.8)$};
